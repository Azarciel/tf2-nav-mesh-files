# Custom made nav mesh files for TF2 community maps
The nav mesh files I've personally made and tailored for some [TF2 community workshop maps](https://steamcommunity.com/workshop/browse/?appid=440&browsesort=mostrecent&section=readytouseitems&actualsort=mostrecent).

Map list:
- [ctf_classic_2fort](https://steamcommunity.com/sharedfiles/filedetails/?id=3686181232) ([link to nav mesh](https://github.com/Azarciel/tf2-nav-mesh-files/blob/main/maps/ctf_classic_2fort.nav))
- [ctf_classic_2fort_cap_edit](https://steamcommunity.com/sharedfiles/filedetails/?id=3688731699) ([link to nav mesh](https://github.com/Azarciel/tf2-nav-mesh-files/blob/main/maps/ctf_classic_2fort_cap_edit.nav))
...
- [pl_saturation](https://steamcommunity.com/sharedfiles/filedetails/?id=3290433599) ([link to nav mesh](https://github.com/Azarciel/tf2-nav-mesh-files/blob/main/maps/pl_saturation_b8.nav))
- [pl_skirmish](https://steamcommunity.com/sharedfiles/filedetails/?id=1351700929) ([link to nav mesh](https://github.com/Azarciel/tf2-nav-mesh-files/blob/main/maps/pl_skirmish_b3.nav))
